...
public class AnalysisResultService {
    ...
    public void applyResult(
        ...
        result.replaceSummary(
                ...
                textOrNull(analysis, "lease_type"),
                textOrNull(analysis, "registry_address"),
                booleanOrNull(analysis, "address_matches_submission"),
                textOrNull(analysis, "address_match_basis"),
                ...
                doubleOrNull(analysis, "jeonse_rate"),
                longOrNull(analysis, "recovery_price_used"),
                longOrNull(analysis, "estimated_recoverable_deposit"),
                doubleOrNull(analysis, "deposit_recovery_rate"),
