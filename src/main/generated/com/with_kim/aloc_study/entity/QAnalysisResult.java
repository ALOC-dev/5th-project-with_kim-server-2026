...
public class QAnalysisResult extends EntityPathBase<AnalysisResult> {
    ...
    public final StringPath addressMatchBasis = createString("addressMatchBasis");

    public final BooleanPath addressMatchesSubmission = createBoolean("addressMatchesSubmission");
    ...
    public final StringPath leaseType = createString("leaseType");
    ...
    public final NumberPath<Long> recoveryPriceUsed = createNumber("recoveryPriceUsed", Long.class);

    public final NumberPath<Long> registeredTenantDepositTotal = createNumber("registeredTenantDepositTotal", Long.class);

    public final StringPath registryAddress = createString("registryAddress");
